...
module.exports = function(Blockly) {
    ...
    Blockly.JavaScript['object_show'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_obj_set_hidden(${dropdown_object}, false);\n`;
        return code;
    };

    Blockly.JavaScript['object_hide'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_obj_set_hidden(${dropdown_object}, true);\n`;
        return code;
    };
    ...
    Blockly.JavaScript['object_set_text'] = function(block) {
        ...
        var code = `lv_label_set_text(${dropdown_object}, ${value_name});\n`;
        return code;
    };

    Blockly.JavaScript['object_led_on'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_led_on(${dropdown_object});\n`;
        return code;
    };

    Blockly.JavaScript['object_led_off'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_led_off(${dropdown_object});\n`;
        return code;
    };
    ...
    Blockly.JavaScript['object_led_set_bright'] = function(block) {
        ...
        var code = `lv_led_set_bright(${dropdown_object}, ${value_brightness});\n`;
        return code;
    };

    Blockly.JavaScript['object_slider_get_value'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_slider_get_value(${dropdown_object})`;
    ...
    Blockly.JavaScript['object_slider_set_value'] = function(block) {
        ...
        var code = `lv_slider_set_value(${dropdown_object}, ${value_value}, LV_ANIM_ON);\n`;
        return code;
    };
    ...
    Blockly.JavaScript['object_chart_add_data'] = function(block) {
        ...
        var code = `lv_chart_set_next(${dropdown_object}, ser1, ${value_data});\n`;
        return code;
    };

    Blockly.JavaScript['object_switch_get_state'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_sw_get_state(${dropdown_object})`;
        return [code, Blockly.JavaScript.ORDER_NONE];
      };

      Blockly.JavaScript['object_switch_on'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_sw_on(${dropdown_object}, LV_ANIM_ON);\n`;
        return code;
    };

    Blockly.JavaScript['object_switch_off'] = function(block) {
        var dropdown_object = block.getFieldValue('object');
        var code = `lv_sw_off(${dropdown_object}, LV_ANIM_ON);\n`;
        return code;
    };
};
